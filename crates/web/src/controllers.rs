...
pub async fn insert_url(
    State(app_state): State<Arc<AppEnv>>,
...
// pub async fn leaderboard(State(app_state): State<Arc<AppEnv>>) -> (StatusCode, Markup) {
...
pub async fn js(State(app_state): State<Arc<AppEnv>>) -> (StatusCode, HeaderMap, String) {
    let mut headers = HeaderMap::new();
...
pub async fn purifyjs(State(app_state): State<Arc<AppEnv>>) -> (StatusCode, HeaderMap, String) {
    let mut headers = HeaderMap::new();
    let mut static_assets_path = (*app_state).config.static_assets_path.clone();
...
pub async fn stylesheet(State(app_state): State<Arc<AppEnv>>) -> (StatusCode, HeaderMap, String) {
    let mut headers = HeaderMap::new();
    let mut static_assets_path = (*app_state).config.static_assets_path.clone();
...
pub async fn not_found(_uri: axum::http::Uri) -> (http::StatusCode, Markup) {
    (http::StatusCode::NOT_FOUND, views::status::not_found())
}
